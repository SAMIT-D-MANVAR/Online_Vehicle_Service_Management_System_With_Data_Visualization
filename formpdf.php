...
$sql="select application_no from customerdetails where customer_name='$name'";
 ...
 <?php  
	...
	<div class="row">
	<div class="col">
<center><img src="projectphotos/trust.jpg" alt="thankyou_logo" class="thank">
